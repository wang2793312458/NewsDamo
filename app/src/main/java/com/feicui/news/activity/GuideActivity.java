...
import com.feicui.news.util.PrefUtil;
...
public class GuideActivity extends AppCompatActivity {
    ...
    // 引导页图片id数组
    private int[] mImageIds = new int[]{R.mipmap.welcome,
            R.mipmap.wy, R.mipmap.small};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBtnStart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //更新sp, 已经不是第一次进入了
                PrefUtil isFinishing = null;
                isFinishing.setBoolean(getApplicationContext(), "is_first_enter", false);
                //跳到主页面
    ...
    private void initData() {
        ...
        for (int i = 0; i < mImageIds.length; i++) {
            ...
            view.setBackgroundResource(mImageIds[i]);// 通过设置背景,可以让宽高填充布
            ...
            mLlContainer.addView(point);//给容器添加原点
        }
    }
